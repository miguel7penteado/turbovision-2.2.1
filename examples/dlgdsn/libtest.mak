...
# gpr2mak ../examples/dlgdsn/libtest.gpr
vpath_header=$(TVSRC)
...
C_ADA_LANG_FLAGS=
LIBS=rhtv
LD_EXTRA_FLAGS=-lrhtv
C_EXTRA_FLAGS=
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))

OBJFILES=codebldr.o consted.o dsgobjs.o freedsgn.o propdlgs.o propedit.o\
	strmoper.o tappwnd.o
ALL_OBJFILES=codebldr.o consted.o dsgobjs.o freedsgn.o propdlgs.o\
	propedit.o strmoper.o tappwnd.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
WUC=
EDITORS=
MAIN_TARGET=freedsgn.exe
PROJECT_ITEMS=codebldr.cc consted.cc dsgobjs.cc freedsgn.cc propdlgs.cc\
	propedit.cc strmoper.cc tappwnd.cc
DEFAULT_MASK=*
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= codebldr.o consted.o dsgobjs.o freedsgn.o propdlgs.o propedit.o\
	strmoper.o tappwnd.o 
NO_LINK=
LINK_FILES=$(filter-out $(NO_LINK),$(DEPS_0))
freedsgn.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=codebldr.cc consted.h dsgdata.h dsgobjs.h fdconsts.h propdlgs.h\
	propedit.h
codebldr.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cc.o)
DEPS_2=consted.cc consted.h
consted.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cc.o)
DEPS_3=dsgobjs.cc dsgdata.h dsgobjs.h fdconsts.h propedit.h strmoper.h
dsgobjs.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cc.o)
DEPS_4=freedsgn.cc consted.h dsgdata.h dsgobjs.h fdconsts.h propedit.h\
	strmoper.h
freedsgn.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cc.o)
DEPS_5=propdlgs.cc consted.h propedit.h
propdlgs.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cc.o)
DEPS_6=propedit.cc consted.h dsgdata.h dsgobjs.h fdconsts.h propdlgs.h\
	propedit.h
propedit.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cc.o)
DEPS_7=strmoper.cc strmoper.h
strmoper.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cc.o)
DEPS_8=tappwnd.cc dsgdata.h dsgobjs.h fdconsts.h propedit.h
tappwnd.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cc.o)
all:: freedsgn.exe
