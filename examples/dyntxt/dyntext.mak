...
# gpr2mak ../examples/dyntxt/dyntext.gpr
vpath_header=$(TVSRC)
...
INCLUDE_DIRS=$(TVSRC)
LIB_DIRS=$(TVOBJ) /usr/src/setedit/makes/linux
C_DEBUG_FLAGS=-g
C_OPT_FLAGS=
C_WARN_FLAGS=
C_C_LANG_FLAGS=
...
OBJFILES=dyntext.o testdyn.o
ALL_OBJFILES=dyntext.o testdyn.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
WUC=
EDITORS=
MAIN_TARGET=dyntext.exe
PROJECT_ITEMS=dyntext.cpp testdyn.cpp
DEFAULT_MASK=*.env
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= dyntext.o testdyn.o 
NO_LINK=
LINK_FILES=$(filter-out $(NO_LINK),$(DEPS_0))
dyntext.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=dyntext.cpp dyntext.h
dyntext.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=testdyn.cpp dyntext.h
testdyn.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
all:: dyntext.exe
