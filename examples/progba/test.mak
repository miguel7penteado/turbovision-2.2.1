...
# gpr2mak ../examples/progba/test.gpr
vpath_header=$(TVSRC) .
...
OBJFILES=example.o tprogbar.o
ALL_OBJFILES=example.o tprogbar.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
PROJECT_ITEMS=example.cpp tprogbar.cpp
DEFAULT_MASK=*
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= example.o tprogbar.o 
NO_LINK=
LINK_FILES=$(filter-out $(NO_LINK),$(DEPS_0))
test.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=example.cpp tprogbar.h
example.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=tprogbar.cpp tprogbar.h
tprogbar.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
all:: test.exe
