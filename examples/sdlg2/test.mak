...
# gpr2mak ../examples/sdlg2/test.gpr
vpath_header=$(TVSRC)
...
OBJFILES=main.o scrldlg.o scrlgrp.o
ALL_OBJFILES=main.o scrldlg.o scrlgrp.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
PROJECT_ITEMS=main.cpp scrldlg.cpp scrlgrp.cpp
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= main.o scrldlg.o scrlgrp.o 
NO_LINK=
LINK_FILES=$(filter-out $(NO_LINK),$(DEPS_0))
test.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=main.cpp dlg.h
main.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=scrldlg.cpp dlg.h
scrldlg.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=scrlgrp.cpp dlg.h
scrlgrp.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
all:: test.exe
