...
# gpr2mak ../examples/tcombo/test.gpr
vpath_header=$(TVSRC)
...
OBJFILES=nmcmbobx.o nmcmbovw.o nmcmbown.o nmsinput.o scombobx.o scombovw.o\
	scombown.o ssinputl.o tcmbovwr.o tcmbowin.o tcombobx.o test.o\
	tsinputl.o
ALL_OBJFILES=nmcmbobx.o nmcmbovw.o nmcmbown.o nmsinput.o scombobx.o\
	scombovw.o scombown.o ssinputl.o tcmbovwr.o tcmbowin.o tcombobx.o\
	test.o tsinputl.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
...
PROJECT_ITEMS=nmcmbobx.cpp nmcmbovw.cpp nmcmbown.cpp nmsinput.cpp\
	scombobx.cpp scombovw.cpp scombown.cpp ssinputl.cpp tcmbovwr.cpp\
	tcmbowin.cpp tcombobx.cpp test.cpp tsinputl.cpp
DEFAULT_MASK=*.txt
...
RHIDE_LIBS=-L/usr/X11R6/lib -lX11 -lXmu -lgpm -lncurses -lstdc++ -lm -lc
RHIDE_NASM=nasm
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= nmcmbobx.o nmcmbovw.o nmcmbown.o nmsinput.o scombobx.o scombovw.o\
	scombown.o ssinputl.o tcmbovwr.o tcmbowin.o tcombobx.o test.o\
	tsinputl.o 
NO_LINK=
...
test.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=nmcmbobx.cpp tcombobx.h
nmcmbobx.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=nmcmbovw.cpp tcombobx.h
nmcmbovw.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=nmcmbown.cpp tcombobx.h
nmcmbown.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
DEPS_4=nmsinput.cpp tsinputl.h
nmsinput.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
DEPS_5=scombobx.cpp tcombobx.h
scombobx.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cpp.o)
DEPS_6=scombovw.cpp tcombobx.h
scombovw.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cpp.o)
DEPS_7=scombown.cpp tcombobx.h
scombown.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cpp.o)
DEPS_8=ssinputl.cpp tsinputl.h
ssinputl.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cpp.o)
DEPS_9=tcmbovwr.cpp tcombobx.h
tcmbovwr.o:: $(DEPS_9)
	$(RHIDE_COMPILE.cpp.o)
DEPS_10=tcmbowin.cpp tcombobx.h
tcmbowin.o:: $(DEPS_10)
	$(RHIDE_COMPILE.cpp.o)
DEPS_11=tcombobx.cpp tcombobx.h
tcombobx.o:: $(DEPS_11)
	$(RHIDE_COMPILE.cpp.o)
DEPS_12=test.cpp tcombobx.h tsinputl.h
test.o:: $(DEPS_12)
	$(RHIDE_COMPILE.cpp.o)
DEPS_13=tsinputl.cpp tsinputl.h
tsinputl.o:: $(DEPS_13)
	$(RHIDE_COMPILE.cpp.o)
all:: test.exe
