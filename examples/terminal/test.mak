...
# gpr2mak ../examples/terminal/test.gpr
vpath_src=e:/dj/contrib/tvision/classes
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
SPECIAL_LDFLAGS=
PROG_ARGS=
SRC_DIRS=e:/dj/contrib/tvision/classes
WUC=
EDITORS=
MAIN_TARGET=test.exe
PROJECT_ITEMS=terminal.cc
DEFAULT_MASK=*.asm
