...
# gpr2mak ../examples/demo/demo.gpr
vpath_src=../../classes
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
...
OBJFILES=ascii.o calendar.o fileview.o gadgets.o mousedlg.o puzzle.o\
	tvdemo1.o tvdemo2.o tvdemo3.o
ALL_OBJFILES=ascii.o calendar.o fileview.o gadgets.o mousedlg.o puzzle.o\
	tvdemo1.o tvdemo2.o tvdemo3.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
...
WUC=
EDITORS=
MAIN_TARGET=demo.exe
PROJECT_ITEMS=ascii.cc calendar.cc fileview.cc gadgets.cc mousedlg.cc\
	puzzle.cc tvdemo1.cc tvdemo2.cc tvdemo3.cc
DEFAULT_MASK=*
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= ascii.o calendar.o fileview.o gadgets.o mousedlg.o puzzle.o\
	tvdemo1.o tvdemo2.o tvdemo3.o 
NO_LINK=
...
calendar.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cc.o)
DEPS_3=fileview.cc fileview.h tvcmds.h
fileview.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cc.o)
DEPS_4=gadgets.cc gadgets.h
gadgets.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cc.o)
DEPS_5=mousedlg.cc mousedlg.h
mousedlg.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cc.o)
DEPS_6=puzzle.cc puzzle.h
puzzle.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cc.o)
DEPS_7=tvdemo1.cc demohelp.h fileview.h gadgets.h puzzle.h tvdemo.h
tvdemo1.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cc.o)
DEPS_8=tvdemo2.cc ascii.h calendar.h demohelp.h tvcmds.h tvdemo.h
tvdemo2.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cc.o)
DEPS_9=tvdemo3.cc calendar.h demohelp.h fileview.h gadgets.h mousedlg.h\
	tvcmds.h tvdemo.h
tvdemo3.o:: $(DEPS_9)
	$(RHIDE_COMPILE.cc.o)
all:: demo.exe
